...
export function CameraControls({
  ...
  const flashLabel = flashMode === 'off' ? 'Off' : flashMode === 'auto' ? 'Auto' : 'On';
    ...
    <>
      ...
      <div className="camera-controls">
        <div className="ctrl-group">
          ...
          >
            {flashMode === 'on' ? (
              <svg viewBox="0 0 24 24" fill="#ffd700" width="22" height="22">
                <path d="M7 2v11h3v9l7-12h-4l4-8z" />
              </svg>
            ) : (
              <svg viewBox="0 0 24 24" fill="#5a4a4a" width="22" height="22">
                <path d="M7 2v11h3v9l7-12h-4l4-8z" />
              </svg>
            )}
          </button>
          <span className="ctrl-label">{flashLabel}</span>
        </div>
